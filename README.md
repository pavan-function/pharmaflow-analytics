...
| 7 | Medical Devices: #1 revenue + #1 returns | €73M revenue / 9.3% return rate |
| 8 | DE = 72% of revenue; AT, NL, CH are growth markets | Berlin alone = €42M |
...
This project uses **synthetic data generated with Python**. It is modeled on real online-pharmacy business operations (Redcare, Shop Apotheke, DocMorris) but does not contain real patient, prescription, or company data. Numbers are illustrative; the methodology is production-grade.
